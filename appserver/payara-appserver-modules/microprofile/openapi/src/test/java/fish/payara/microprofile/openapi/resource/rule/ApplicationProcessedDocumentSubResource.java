...
import fish.payara.microprofile.openapi.test.app.TestApplicationSubResource;
 ...
 */
public class ApplicationProcessedDocumentSubResource extends OpenAPIImpl {

    public ApplicationProcessedDocumentSubResource() throws MalformedURLException {
        // Apply base processor
        new BaseProcessor(asList(new URL("http://localhost:8080/testSubResource"))).process(this, null);

        ApplicationClassLoader appClassLoader = new ApplicationClassLoader(new TestApplicationSubResource());
